...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Cosmoria Support",
            "url": "https://cosmoria.dev/support",
            "email": "support@cosmoria.dev"
        },
        "license": {
            "name": "Apache 2.0",
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/adminauth.AuthResult"
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/adminauth.ProjectWithRole"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/adminauth.Project"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/admin/projects/{pid}/admin-roles": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/adminauth.AdminProjectRole"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Admin user ID and role",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/admin/projects/{pid}/api-keys": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "User ID and key name",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/auth.CreateApiKeyResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.updateCollectionSchemaRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/rbac.RoleWithPermissions"
                            }
                        }
                    },
                    "401": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/rbac.UserProjectRole"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.userRoleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/setup": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "token, admin, project",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/projects/{pid}/tenants/{tid}/collections/{cid}/records": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Pagination cursor (record ID)",
                        "name": "cursor",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "data: [Record], next_cursor: string",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/records.Record"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.updateRecordRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.assignUserRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "adminauth.AuthResult": {
            ...
            "properties": {
                "admin": {
                    "$ref": "#/definitions/adminauth.AdminUser"
                },
                "token": {
                    "type": "string"
                }
        ...
        "collections.Collection": {
            ...
            "properties": {
                ...
                "schema": {
                    "$ref": "#/definitions/collections.Schema"
                }
            }
        },
        "collections.Field": {
        ...
        "collections.Schema": {
            ...
            "properties": {
                "fields": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/collections.Field"
                    }
                }
            }
        },
